program CFCage
  ...
  character(len=40), parameter :: file_cfc11 = "GLODAPv2.2020_CFC11_1x1degrees.nc"
  character(len=40), parameter :: file_cfc12 = "GLODAPv2.2020_CFC12_1x1degrees.nc"
  character(len=38), parameter :: file_sf6 = "GLODAPv2.2020_SF6_1x1degrees.nc"
  integer :: ncid, varid
  ...
  !!! Save the data
  call check( nf90_create("GLODAPv2.2020_CFC11age.nc", nf90_clobber, ncid) )
  ...
  call check( nf90_create("GLODAPv2.2020_CFC12age.nc", nf90_clobber, ncid) )
  call check( nf90_def_dim(ncid, 'RECORD', nyears, yeardim_id) )
  call check( nf90_def_dim(ncid, 'TIME_COUNTER', nmonths, monthdim_id) )
  call check( nf90_def_dim(ncid, 'DEPTHT', ndeps, depdim_id) )
  call check( nf90_def_dim(ncid, 'ETOPO60Y', nlats, latdim_id) )
  ...
  call check( nf90_create("GLODAPv2.2020_SF6age.nc", nf90_clobber, ncid) )
  call check( nf90_def_dim(ncid, 'RECORD', nyears, yeardim_id) )
  call check( nf90_def_dim(ncid, 'TIME_COUNTER', nmonths, monthdim_id) )
  call check( nf90_def_dim(ncid, 'DEPTHT', ndeps, depdim_id) )
  call check( nf90_def_dim(ncid, 'ETOPO60Y', nlats, latdim_id) )
