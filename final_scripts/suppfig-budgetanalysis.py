...
fig.savefig('fig-suppfig-budgetanalysis.png', dpi=300, bbox_inches='tight')
fig.savefig('fig-suppfig-budgetanalysis_trans.png', dpi=300, bbox_inches='tight', transparent=True)
